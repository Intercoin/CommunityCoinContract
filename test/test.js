...
describe("Staking contract tests", function () {
    ...
    beforeEach("deploying", async() => {
        ...
        const StakingTransferDisallowF = await ethers.getContractFactory("StakingTransferRules");
    ...
    it("shouldnt create with uniswap pair exists", async() => {
        await expect(stakingFactory["produce(address,address,uint256,uint256,uint256,uint256)"](
    ...
    describe("Instance tests", function () {
        ...
        beforeEach("deploying", async() => {
            ...
            let tx = await stakingFactory.connect(owner)["produce(address,address,uint256,uint256,uint256,uint256)"](
                erc20ReservedToken.address,
                erc20TradedToken.address,
                lockupIntervalCount,
                reserveTokenClaimFraction,
        ...
        describe("redeem tests", function () {
            ...
            beforeEach("before each callback", async() => {
                ...
                let tx = await stakingFactory["produce(address,address,uint256)"](
                    erc20ReservedToken.address,
                    erc20TradedToken.address,
                    DaysCount
                )
